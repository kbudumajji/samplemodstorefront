 ...
 *
 */
package com.mss.storefront.controllers.pages.checkout.steps;
...
import com.mss.storefront.controllers.ControllerConstants;
...
public class PaymentMethodCheckoutStepController extends AbstractCheckoutStepController
{
	...
	@RequestMapping(value = "/wthr", method = RequestMethod.GET)
	@RequireHardLogIn
	public @ResponseBody String getWeather()

	{

		String resultantantOutput = "";

		String output = "";



		//String url = "https://api.us.apiconnect.ibmcloud.com/miracleinc-alkspace/sb/weather?appid=0f9e50a545779bb63149670c93835e9b&q=";

		String url = "https://api.au.apiconnect.ibmcloud.com/lanadasu3021a1-dev/sb/api/wthr16?q=";

		//		String url = "https://api.au.apiconnect.ibmcloud.com/lanadasu3021a1-dev/sb/api/wthr16?q=Austria,Vienna&mode=json&units=metric&cnt=5&appid=6c5abb9df54f41bbf5e691123c4cb0b0&clie";

		//		url = url + "nt_id=a5a3afd8-12c8-4205-a903-c350a2759463";
...

		{
			...
			+ cartData.getDeliveryAddress().getCountry().getName());

			final String country = cartData.getDeliveryAddress().getCountry().getName();

			final String location = cartData.getDeliveryAddress().getTown();



			//url = url + country + "," + location + "&client_id=f012e67c-fbe1-4286-9926-4de1fbf5cc06";
			...
			+ "&mode=json&units=metric&cnt=5&appid=6c5abb9df54f41bbf5e691123c4cb0b0&client_id=a5a3afd8-12c8-4205-a903-c350a2759463";
			...
			//"https://api.us.apiconnect.ibmcloud.com/miracleinc-alkspace/sb/weather?appid=0f9e50a545779bb63149670c93835e9b&q=India,hyderabad&client_id=f012e67c-fbe1-4286-9926-4de1fbf5cc06"
...

			{
				...
				resultantantOutput = output;

				System.out.println("output is -------->>>>>>>>" + resultantantOutput);
			...
			//LOG.info("=============generateAuthToken======================" + resultantantOutput);
