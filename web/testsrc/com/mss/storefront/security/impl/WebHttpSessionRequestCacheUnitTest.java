...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/samplemodstorefront/electronics/en",
						"https://electronics.local:9002/samplemodstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/samplemodstorefront/electronics/en",
						"https://electronics.local:9002/samplemodstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/samplemodstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/samplemodstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/samplemodstorefront/electronics/en",
						"https://electronics.local:9002/samplemodstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/samplemodstorefront",
						"https://electronics.local:9002/samplemodstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/samplemodstorefront",
						"https://electronics.local:9002/samplemodstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/samplemodstorefront/electronics/en",
						"https://electronics.local:9002/samplemodstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
